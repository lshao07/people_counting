function outParams = DPU_TrackerProc_process(handle, numObjsIn, detObjIn, detObjInSideInfo, outParams)
    
%     global trackerProcObj;
    global trackerProcObj;

    trackerProcObj = handle;
...
%     [tNum, targetDescr] = gtrack_step(trackerProcObj.gtrackHandle, trackerProcObj.pointCloud, mNum, targetIndex);
    [tNum, targetDescr] = gtrack_step(points, mNum, targetDescr, targetIndex);
