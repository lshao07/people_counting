...
%     trackerProcObj.pDpuCfg = pConfigIn;
    ...
    trackerProcObj.targetDescrHandle.tList = cat(1, zeros(1, pStaticCfg.staticCfg.gtrackModuleConfig.maxNumTracks), zeros(1, pStaticCfg.staticCfg.gtrackModuleConfig.maxNumTracks));
